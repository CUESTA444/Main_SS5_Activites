...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="../Functions/mainFunctions/AddEmployee.php" method="POST" class="p-4 shadow-sm rounded" style="background-color: #f9f9f9;">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address" name="address" rows="3" required></input>
            </div>
